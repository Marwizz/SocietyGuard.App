import {
  ...
  import { groupVisitorOTP, addGuestEntry } from "../services/operations/preApproveApi";
          ...
          {isLoading ? (
            ...
            groupInvites.map((invite, index) => (
              <View key={invite._id || index} style={styles.card}>
                <TouchableOpacity onPress={() => openModal(invite.partyCode)}>
          ...
          >
            <View style={styles.modalView}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setGuestDetails(prev => ({...prev, name: text}))}
              />
              ...
              <TextInput
                ...
                onChangeText={(text) => setGuestDetails(prev => ({...prev, mobile: text}))}
