...
const CabEntryModal = ({ visible, onClose, onSubmit, societyId }) => {
  ...
  const createVisitorEntry = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${EXPO_PUBLIC_BASE_URL}/auth/cab/create`,
        visitorData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                maxLength={4}
                value={guestData.vehicleNumber}
                onChangeText={(text) =>
                  setGuestData({ ...guestData, vehicleNumber: text })
                }
              />
            </View>
